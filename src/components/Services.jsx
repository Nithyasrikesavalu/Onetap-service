    ...
    <section className="relative bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 py-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-700 mb-4 font-light">தொழில்முறை சேவைகள்</p>
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium">
            Experience premium services with cutting-edge solutions tailored to your unique needs
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-20">
          {filteredServices.map((service, index) => (
            ...
            >
              {/* Glow Effect */}
              <div className={`absolute -inset-1 bg-gradient-to-r ${service.color} rounded-2xl blur opacity-0 group-hover:opacity-20 transition-all duration-500 group-hover:scale-105`}></div>
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-xl border border-slate-200/60 group-hover:border-transparent transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-blue-500/20 overflow-hidden">
                ...
                <div className="relative p-6 border-b border-slate-100/60 group-hover:border-slate-200/30 transition-colors duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <div className={`p-3 rounded-xl bg-gradient-to-br ${service.color} text-white shadow-lg transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 relative overflow-hidden`}>
                      <Icon name={service.icon} className="w-5 h-5 relative z-10" />
                ...
                <div className="relative p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    {service.features.map((feature, idx) => (
                      <div 
                        key={idx} 
                        className="flex items-center gap-3 text-sm text-slate-500 group-hover:text-slate-600 transition-colors duration-300 transform group-hover:translate-x-1 transition-transform duration-300"
                        style={{ transitionDelay: `${idx * 100}ms` }}
                      >
                        <div className={`w-2 h-2 bg-gradient-to-r ${service.color} rounded-full flex-shrink-0 transform group-hover:scale-125 transition-transform duration-300`}></div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 mb-16 border border-slate-200/60 hover:shadow-xl transition-all duration-500">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {[
              { number: `${services.length}+`, label: "Services", color: "from-blue-500 to-cyan-500" },
              { number: "500+", label: "Happy Clients", color: "from-green-500 to-emerald-500" },
              { number: "99%", label: "Success Rate", color: "from-purple-500 to-violet-500" },
              ...
              <div key={index} className="group cursor-pointer transform hover:scale-105 transition-all duration-300">
                ...
                <div className={`w-8 h-1 bg-gradient-to-r ${stat.color} rounded-full mx-auto mt-3 transform group-hover:scale-110 transition-transform duration-300`}></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600/90 to-purple-600/90 rounded-3xl p-12 text-white relative overflow-hidden backdrop-blur-sm border border-white/20 hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-500 group">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <span className="group-hover/btn:scale-110 transition-transform duration-300">Contact Us</span>
