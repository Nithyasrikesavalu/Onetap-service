        ...
        <div className="mt-6 text-center">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 mb-12 relative z-10">
            <div className="text-center">
              <p className="text-slate-400 text-sm mb-6">Trusted by teams at leading companies</p>
              <div className="flex flex-wrap justify-center gap-8 opacity-70">
                {['Google', 'Microsoft', 'Apple', 'Amazon', 'Netflix', 'Spotify'].map((company, index) => (
                  <div key={index} className="text-lg font-semibold text-slate-300 hover:text-white transition-colors duration-300 hover:scale-105">
                    {company}
                  </div>
                ))}
              </div>
