      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-gray-200 shadow-sm mb-6">
            ...
            <span className="text-xs font-medium text-gray-600 tracking-wider">CONTACT US</span>
            <div className="w-1.5 h-1.5 bg-blue-500 rounded-full animate-pulse"></div>
          </div>
          ...
          <p className="text-xl text-gray-700 mb-3 font-light">தொடர்பு கொள்ளுங்கள்</p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@docservices.com</p>
                    <p className="text-gray-600">support@docservices.com</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <a
                      key={social.icon}
                      href="#"
                      className={`w-10 h-10 bg-${social.color}-100 rounded-lg flex items-center justify-center hover:bg-${social.color}-200 transition-colors duration-200`}
                    >
